#Este es respaldo del código para el juego  piedra papel ó tijera
# tijera gana a papel
# papel gana a piedra
...
Reglas:
 - Lo que NO suma puntos, pero sí cuenta como una ronda:
   - - si hay un empate
   - - Si el usuario coloca mal la elección:
  """
...
def reglas_func(user, machine, user_name):
    global user_wins
    global machine_wins
...
def juego():
    ...
    while True:
        ...
        if empate(user, machine, user_name) == True:
            ...
            reglas_func(user, machine, user_name)
            ronda_actual = ronda_actual +1
